...
class UnitType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder->add('attackPoints', 'number');
        $builder->add('defensePoints', 'number');
        ...
        $builder->add('unitResources', 'collection', array(
            'type' => new UnitResourceType(),
            'label' => 'Unit resources cost',
            'allow_add' => true,
            'allow_delete' => true,
            'delete_empty' => true,
            'prototype' => true,
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'Application\Entity\UnitEntity',
